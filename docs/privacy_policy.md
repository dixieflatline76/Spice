...
### 2. Local Operation
The Application and Extension operate primarily on your local machine.
...
- **Spice Wallpaper Manager Extension:** Communicates **only** with the locally installed Desktop App via a local loopback connection (`127.0.0.1` / `localhost`). It does not send data to any external cloud servers managed by us.
...
The Application connects to third-party wallpaper providers (Wallhaven, Pexels, Unsplash, Wikimedia Commons) to download images *at your request*.
