...
type Plugin interface {
	...
	CreateTrayMenu() *schema.MenuSchema                           // Returns menu items to add to the tray.
	CreatePrefsSchema(setting.SettingsManager) *schema.TabsSchema // Returns declarative preferences tabs.
